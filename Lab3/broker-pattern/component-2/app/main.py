...
async def publish_item(item: Item):
    try:
        ...
        async with connection:
            ...
            await channel.default_exchange.publish(aio_pika.Message(body=json.dumps(item.dict()).encode(),delivery_mode=aio_pika.DeliveryMode.PERSISTENT),routing_key=QUEUE_NAME,)
